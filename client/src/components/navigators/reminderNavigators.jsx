...
import Reminders from '../../assets/remainder.svg'
...
class ReminderNavigator extends Component {
    render() {
        ...
        return ( this.props.remiderArray.length>0?
            ...
            <MuiThemeProvider>
                <div id="emptyNotes1"> 
                    <img src={Reminders} alt =""style={{width:"135px" ,opacity:0.3,marginLeft:"12px", marginTop:"135px"}}>
                    </img>
                </div>
          <h3 style={{opacity:0.3}} >  Notes with reminders appear here </h3>
            </MuiThemeProvider>
        )
    }
}
